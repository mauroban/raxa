...
- **Patentes** em vez de pontos: 4 patentes × 3 divisões (Ferro → Bronze → Prata → Ouro). **O rating numérico existe por baixo e nunca é mostrado a ninguém** — e o admin pode fechar até a patente, deixando-a visível só para ele.
