...
A.subPick({dataset:{s:'0',id:L().live.cur.lineups[0][0]}});snap('partida com nome marcado para substituir');
A.subPick({dataset:{s:'0',id:L().live.cur.lineups[0][0]}});
A.subPick({dataset:{s:'0',id:L().live.cur.gks[0]}});snap('partida com goleiro marcado para trocar');
A.subPick({dataset:{s:'0',id:L().live.cur.gks[0]}});
