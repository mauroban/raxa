...
{ const n=mk('Novo',1500,0);n.L.def=false;
  ok(!temPatente(liga,n,'L'),'novato sem nivel manual e sem calibrar NAO tem nivel');
  n.L.games=CAL_GAMES;ok(temPatente(liga,n,'L'),'depois de calibrar, tem');
  const m2=mk('Manual',1500,0);m2.L.def=true;ok(temPatente(liga,m2,'L'),'nivel dado a mao aparece desde o inicio');
...
{ const j1=juntaOpinioes([1500]);ok(j1.e===1500&&!j1.dv,'uma opiniao: vale ela');
  ...
  const j9=juntaOpinioes([stepMid(1),stepMid(1),stepMid(7),stepMid(7),stepMid(7),stepMid(7),stepMid(7),stepMid(13),stepMid(13)]);ok(Math.round(j9.e)===Math.round(stepMid(7)),'nove opinioes: tira duas de cada ponta, ficam as cinco do meio (D-177)');
  const j10=juntaOpinioes([stepMid(1),stepMid(4),stepMid(7),stepMid(7),stepMid(7),stepMid(7),stepMid(10),stepMid(13)]);ok(Math.round(j10.e)===Math.round((stepMid(4)+stepMid(7)*4+stepMid(10))/6),'oito opinioes: ainda tira uma de cada ponta (D-177)');
  const j12=juntaOpinioes([stepMid(1),stepMid(1),stepMid(4),stepMid(7),stepMid(7),stepMid(7),stepMid(7),stepMid(7),stepMid(7),stepMid(10),stepMid(13),stepMid(13)]);ok(Math.round(j12.e)===Math.round((stepMid(4)+stepMid(7)*6+stepMid(10))/8),'doze opinioes: tira duas de cada ponta, ficam oito (D-177)');
