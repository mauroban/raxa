...
- Cada partida do histórico mostra a **chance de cada lado no apito** (ex.: `62% × 38% no apito`), calculada com o nível que cada um tinha **naquele momento** — é % de confronto, a mesma da pré-partida, e some junto com as patentes quando a liga as fecha (D-75).
