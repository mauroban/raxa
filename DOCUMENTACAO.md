...
**As opiniões seguem a mesma regra.** Onde a patente aparece, a ficha mostra a **entrada** (badge, quantas opiniões, se é média ou mediana), o **hoje**, o aviso de divergência e a lista de opiniões com o nome de quem deu cada uma — para todo mundo, de qualquer papel. Quem lança vê também a escada da própria opinião (na ficha) e o card **Minhas opiniões** na aba Jogadores, que abre a lista de todo mundo com um toque por pessoa e conta quantas faltam. Com as patentes fechadas, some tudo.
