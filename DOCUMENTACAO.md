...
**Escalação sempre à vista.** Na pré-partida e na partida ao vivo, logo abaixo do nome/placar de cada time, aparece a escalação em duas colunas: o goleiro num slot próprio em cima (🧤, com ↻ se vier do rodízio) e um slot por vaga de linha (5 no 5v5; vaga vazia fica tracejada). Quem não é do time de origem leva um ⇄ discreto (emprestado, completando ou substituto). Ao vivo, tocar num nome substitui; tocar no goleiro troca o goleiro.
