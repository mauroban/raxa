...
**Revisão de partida corrige autor de gol.** Na revisão (admin), além do resultado, cada gol da partida aparece com autor e time; tocar abre a escolha entre quem estava em quadra pelo time que marcou (ou pelo outro, na abinha "contra"). A artilharia é recontada e a correção fica no registro.
