...
- **Tirar o palpite (D-91).** Na ficha, o admin pode remover o nível dado à mão de **qualquer um**. Quem nunca jogou naquela valência volta ao rating de entrada e fica sem nível até completar a calibração. Quem já jogou tem o histórico inteiro reaplicado por cima da entrada padrão, **sem palpite** — com o K maior de quem está calibrando, as partidas mandam mais — e a ficha mostra antes de salvar o hoje que vai sair (D-86). É a saída para o palpite que se revelou errado (o de goleiro, tipicamente — D-90): em vez de chutar outra entrada, tira-se o chute. Fica no registro de correções ("palpite removido — histórico reaplicado"). **Sem nível até calibrar.** Quem entra sem um nível dado à mão (cadastro ou admin) não recebe rótulo enquanto calibra (15 partidas no racha curto; 3 rachas na partida única): o rating existe por baixo — monta time, entra na conta dos outros — mas a escada mostra a pessoa em "Sem nível ainda", com o progresso da calibração.
...
O rating numérico é quase invisível: na aba Jogadores, **só o admin** vê o Elo cru de cada um, num número pequeno e apagado no canto da linha (com a dica "Elo — só o admin vê"). Ao lado dele, o admin vê o **aviso de revisão** (D-83): o app soma, por trilha, o quanto cada um rendeu acima ou abaixo do esperado nos **últimos 8 rachas** (normalizado por √partidas, mínimo 10 partidas na janela) e marca os **3 de cada ponta** com **📈/📉 Nº de M em render acima/abaixo do esperado — revisar palpite?**, na escada e na ficha (a ficha mostra a posição de todo mundo). É aviso para uma correção humana — o motor nunca mexe sozinho por isso: em simulação, K automático por sequência ou por surpresa amplifica ruído; um limiar absoluto também não serve (quem está uma patente fora rende só +0,07 por partida acima do esperado, porque o time dilui); o que funciona é a posição no ranking — quem está uma patente fora do lugar aparece no top 5 em ~2/3 dos casos com 2–3 meses. As linhas dos rankings da aba Stats abrem a ficha, para a correção ser um toque. Para todo o resto — e para todos os outros papéis — o número não existe: a linguagem pública é a patente.
