...
dourado e o texto "6 divisões abaixo (ou acima) da opinião média" ("da entrada" só era claro
para quem pediu a régua; "opinião média" diz com o que se compara). A régua é a entrada (média aparada), não o Elo de
