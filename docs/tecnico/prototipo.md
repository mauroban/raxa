...
- **Confirmação de presença pelo app** (D-165): agenda semanal da liga, lista abre N dias antes, "Vou"/"Vou no gol" com espera por papel derivada da hora do servidor, quem lança confirma pelos outros (e a pessoa assume com "Confirmo", D-178), texto para o grupo com o endereço da quadra (busca com sugestões do OpenStreetMap, D-180) e link do mapa (D-179), cancelar a data; no dia, a presença já vem marcada. E **"Quem é você nesta liga?"** (D-166): o membro novo escolhe o próprio perfil ou cria o seu com apelido
