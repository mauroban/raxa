...
- **Corrigir partida** encerrada — gols (time, minuto, autor, contra; adicionar, apagar), escalação e trocas — reescrevendo o log e os trechos (D-61, D-198); placar e resultado recontados dos gols; registro de correções por liga
