...
O que o app mostra a todo mundo é sempre: **patente + divisão**, a campanha (V/E/D — na ficha e em Stats; a escada de Jogadores é só nome e nível, D-175) e o momento em que alguém sobe ou cai. Gols e forma recente ficam na ficha e na aba Stats — a escada é sobre nível (D-84). Fora da linha discreta do admin, o rating só existe no backup/servidor, como dado técnico.
...
- **A entrada é feita de opiniões (D-95).** O nível de entrada de cada trilha não é um palpite de uma pessoa: é o que sai das **opiniões de quem lança** (admin, moderador, lançador) — uma por pessoa, todas visíveis a todos. Uma opinião vale ela; duas, a **média** (fica no meio: um erro de patente inteira vira meio erro); três ou mais, a **média aparada dos dois terços centrais**: tira um sexto das opiniões de cada ponta (arredondado, no mínimo uma) e faz a média do resto — com 3 é a mediana, com 4 as duas centrais, com 5 as três centrais, até 8 sai uma de cada lado, de 9 a 14 saem duas, de 15 a 20 três (D-96, D-177). Uma opinião destoante não puxa a entrada, e as do meio pesam todas. Quando as opiniões **divergem** (desvio mediano de uma patente ou mais — Prata × Diamante, ou Bronze/Ouro/Lenda), a pessoa entra no meio, mas com o **K de quem está sem palpite**: as partidas decidem rápido, e a ficha avisa. **Qualquer membro com perfil vinculado pode dar a sua opinião — inclusive Jogador —, mas ela só vale enquanto quem deu for Lançador ou acima** (D-121). Quem vira Jogador não perde nada: as opiniões dele ficam registradas (a ficha as mostra apagadas, "não vale (Jogador)"), só deixam de entrar na conta; se voltar a Lançador, voltam a valer. O histórico reaplica nos dois sentidos. **Não existe anular a opinião de uma pessoa específica**: se o admin não confia no olhar de alguém, rebaixa a pessoa a Jogador — é isso que tira o peso das opiniões dela, todas de uma vez. Quem sai da liga leva as opiniões junto. Não se opina sobre si mesmo. **Tirar a própria opinião** é tocar de novo na patente (ou o botão na ficha). Cada mudança de opinião reaplica o histórico por cima da entrada nova, na hora. Tudo fica no registro de correções ("opinou sobre o nível", "mudou permissão"). **Sem nível até calibrar.** Quem entra sem um nível dado à mão (cadastro ou admin) não recebe rótulo enquanto calibra (15 partidas no racha curto; 3 rachas na partida única): o rating existe por baixo — monta time, entra na conta dos outros — mas a escada mostra a pessoa em "Sem nível ainda", com o progresso da calibração.
...
- **Menos goleiros que times** (o caso comum) → eles ficam **à parte** dos times (rodízio, D-140): com dois ou mais, **cada um fica no seu gol** e quem sobra espera e entra no gol de quem perder; com um só, ele reveza de lado. Ver [Regras do racha](regras-do-racha.md).
...
**As opiniões seguem a mesma regra.** Onde a patente aparece, a ficha mostra a **entrada** (badge, quantas opiniões, se é média ou mediana), o **hoje** e o aviso de divergência — para todo mundo, de qualquer papel; o detalhe de quantas de cada patente e os extremos, só para moderador ou acima (D-197). **Opinião individual não aparece na ficha de ninguém** (D-125): nem para o admin. Fica a contagem ("3 opiniões") para todo mundo e, logo abaixo, **quantas de cada patente** ("Bronze 2 · Prata 4", D-194) — o consolidado, sem nome, **só para moderador ou acima** (D-197). Jogador e lançador ficam com a entrada e a contagem: em grupo pequeno, "Ferro 1" aparecendo logo depois de alguém opinar entrega quem foi, e não há atraso nem mínimo de opiniões que resolva isso sem complicar — quem não modera fica por fora do miolo do motor. Pela mesma razão, o aviso de divergência diz as duas patentes extremas ("Ferro × Ouro") só para moderador ou acima; os outros leem "Opiniões muito diferentes: as partidas mandam mais". Opinião é entre quem deu e a liga, não entre pares — pública, vira cobrança ("você me deu Bronze?") e nota combinada. O único lugar em que se vê nota por nome é o botão do admin *"Opiniões que Fulano deu"* (D-124), que olha pelo lado de quem opinou. **A opinião só se dá pelo card "Minhas opiniões"** (D-127): a ficha não tem mais a escada da própria opinião — o painel mostra só a **entrada** (o hoje já está no cartão do topo da ficha, com partidas e V/E/D; repetir embaixo era ruído). **Não diz a sua nota nem leva ao cartão** (D-196): o botão "Sua opinião: Ouro · mudar ›" saiu, porque ao lado do consolidado dos outros ele induzia a mudar a nota pela dos outros — quem quer rever a sua vai ao card Minhas opiniões. Com a escada logo abaixo do badge de entrada, a pessoa dava a nota olhando a entrada mudar; e o aviso de "opinião salva" não diz mais a entrada que resultou. Quem lança acha o card **Minhas opiniões** na aba Jogadores. Ele abre **uma pessoa por vez, num cartão**: avatar, nome, a descrição (apelido, "amigo do Matheus" — mais discreta que o nome, para saber de quem se fala; D-128) — **sem o nível de hoje** (para quem nunca jogou ele é a média das opiniões dos outros, e mostrá-lo ancorava a nota; D-127) — e as **cinco patentes como opções** — o badge de metal e, ao lado, uma frase curta do que cada uma representa em termos do que o *time ganha* com a pessoa em quadra ("bem abaixo da média: o time tem que carregar" · "abaixo da média: o time cobre algo por ele" · "a média do racha; na dúvida, é aqui" · "acima da média: faz falta quando não vem" · "muda o patamar do time sozinho; raro"), porque é essa a régua do nível (D-90) e é o que corrige o olhar do drible. Abaixo do cartão, só a dica "Pense no que o time ganha com a pessoa em quadra". Com **tudo dado**, a folha abre no "✓ todas dadas" (com o atalho para a outra posição, se lá faltar) em vez do cartão de alguém — um cartão por padrão dava a sensação de que ainda faltava opinar; a lista de baixo continua ali para rever qualquer um. **O cartão inteiro cabe na tela de um celular sem rolar** (D-120): as frases são de uma linha no computador e duas no celular, e o que os outros opinaram fica na ficha da pessoa, não no cartão — a pergunta aqui é a *sua* opinião. Um toque salva e passa para a próxima pessoa ainda sem a sua opinião; "‹ Anterior" e "Pular ›" andam na ordem, que é fixada ao abrir (quem falta primeiro). A sexta opção é **"Não sei"** (nunca vi jogar direito): conta como resposta dada — a pessoa sai da sua lista de pendentes — mas fica fora da conta da entrada. Com **5 ou mais** opiniões pendentes, o card e a aba Jogadores **pulsam** devagar até você ir lá — e o caminho é guiado até o último passo: o card diz onde falta ("faltam 12 na linha · 2 no gol"), o toque abre a folha **na posição em que falta** e **na primeira pessoa pendente**, o seletor Linha/Gol mostra quantas faltam em cada, e o cartão de "todas dadas" oferece ir para a outra posição quando lá ainda falta. Embaixo, a lista de todos com a sua opinião ao lado, para conferir e voltar a qualquer um — ordenada por **quem ainda não tem a sua opinião primeiro, depois de Diamante a Ferro, e "não sei" no fim** (D-126); a ordem do cartão ("Próximo") continua fixa desde a abertura. A nota é dada **onde a pessoa joga**: na aba Linha os cartões são só de quem joga na linha; na aba Gol, só de quem vai ao gol (costuma, ou já pegou). Os outros aparecem no fim da lista, apagados: ninguém é obrigado a opinar sobre quem não joga naquela posição (o goleiro na aba Linha, o jogador de linha na aba Gol), mas **tocar no nome abre o cartão dele** mesmo assim, marcado "fora da fila", com "Voltar à fila" no lugar do Próximo (D-121). Com as patentes fechadas, some tudo.

**O admin vê também o lado inverso: tudo que um membro opinou sobre os outros** (D-124). Na ficha de qualquer pessoa, só para o admin, o botão *"Opiniões que Fulano deu"* (com a contagem) abre uma folha por posição — cada nome com a patente dada (ou "não sabe") e a data, e o aviso de que elas não valem quando a pessoa hoje é Jogador (D-121). A nota que fica a **4 divisões ou mais da entrada** da pessoa avaliada vem marcada em dourado com "6 divisões abaixo (ou acima) da opinião média" (D-194): quem recebe Ouro e Prata de todo mundo e Bronze de um só tem esse Bronze apontado — é só leitura, para a conversa, não muda a entrada. É só leitura: serve para entender por que uma entrada ficou onde ficou e para conversar com quem está fora da curva, não para apagar nota (D-121 tirou isso de propósito). Some com as patentes fechadas, como tudo que fala de nível.
