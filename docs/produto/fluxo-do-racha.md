...
O app **sugere** quem completa (quem menos jogou na noite, para a fila girar), mas **quem decide é você**: toque no nome para tirar e escolher outro, ou toque em *Jogar 4v4 assim* para os dois lados entrarem menores. **A vaga tracejada fica à vista mesmo assim** (D-123): time com um a menos sempre tem um slot para alguém preencher se quiser — um toque na vaga e outro em quem está fora, ou arrastar o nome até ela, volta a completar.

Se mesmo assim um time entra incompleto, a tela avisa (“jogando 4v4 — puxe alguém de fora para fechar 5v5”) em vez de esconder o problema — e o aviso vale para **qualquer um dos dois lados** (D-122; antes só o da esquerda era conferido).

**Refazer times** no meio do racha começa uma rodada nova de verdade: o "🧤 fica" e o goleiro do time que venceu não passam para o time novo que herdou o mesmo número (D-122).
...
- **Na pré-partida vale a mesma gramática (D-123)** — sem folha de goleiro: toque ou arraste, com o 🧤, o gol vazio e a vaga como slots, e o tracejado verde mostrando o par. O que muda é que ali não há partida rodando, então o toque mexe no **estado da rodada**:
  - **nome ⇄ nome** (de linha, da fila, de outro time, entre os dois lados): **trocam de lugar de vez**, como na montagem — inclusive o goleiro fixo com alguém de linha do outro lado (trocam de time);
  - **alguém de fora → 🧤** com rodízio: é o goleiro **só desta partida**; o do rodízio descansa e aparece no grupo **🧤 Rodízio** do card "Fora", de onde volta com um toque. Com **goleiro fixo**, o goleiro é do time: quem entra no gol **entra no time no lugar dele** (ganha o 🧤 do dia) e o antigo vai para a fila com o 🧤;
  - **de linha ⇄ 🧤 do mesmo lado**: trocam de papel nesta partida. Com rodízio, quem improvisa deixa a **vaga de linha**, o app já sugere quem completa e quem completa **entra de fato na largada** (D-122; antes era cortado e o time largava 4v5);
  - **alguém de fora → vaga**: completa esta partida (empréstimo, aparece com ⇄; tocar nele sem marca tira);
  - **🧤 ⇄ 🧤 entre lados**: trocam de gol (com goleiro fixo, trocam de time); **🧤 → vaga do mesmo lado**: o goleiro joga na linha e o gol fica vazio;
  - **os times que esperam também têm vaga**: no card "Fora", um time com gente a menos mostra o "＋ vaga" tracejado, e quem for tocado ou arrastado nela (da fila, de outro time, de um dos lados que jogam) **entra naquele time de vez**;
  - **no card "Fora" o chip é a pessoa, não o slot que ela ocupa**: quem improvisou no gol emprestado continua listado no time dele, e trocá-lo ali com alguém de outro time **troca de time, não de goleiro** — ele segue no gol.
  A dica abaixo da escalação diz o próximo passo e, com o 🧤 ou uma vaga marcados, leva a **"outras opções"** / **"escolher da lista"** (a folha antiga: sem goleiro definido, voltar à sugestão, a lista de quem completa com quantas jogou).
...
- **"Chegou agora"** (o atrasado): marca presença e manda direto para um time — ou para o rodízio de goleiros — no meio do racha. **Racha montado com goleiro fixo em cada time** (sem rodízio): "chegou para ser goleiro" põe a pessoa **na fila, com o 🧤 do dia** — não existe rodízio para entrar, e escalá-la "além" de um time fazia o app largar 6v5. Dali ela completa ou troca de lugar com o goleiro de um time como qualquer um, e no lado em que entrar com o 🧤 ela é o goleiro (D-122).
- **"Foi embora"** (toque no botão, ou **arraste o nome até ele** — a confirmação é a mesma): quem já jogou hoje (ou está em quadra) sai contando presença (D-49). Quem **ainda não jogou** ganha a escolha: *🚑 Foi embora — esteve no racha* (conta presença) ou *✕ Marquei errado — não veio* (sai sem contar). Presença marcada por engano depois de montar os times não pode virar frequência. Quem estava **em quadra** sai da partida sem ninguém no lugar, e o `↶` desfaz a saída **inteira**: volta à escalação na mesma posição, à presença, ao time, ao rodízio e ao 🧤 do dia (D-122) — antes voltava só à quadra e sumia do racha na partida seguinte. Se a pessoa era o **goleiro escolhido na mão** para a próxima partida, a escolha cai e vale de novo a sugestão do app.
