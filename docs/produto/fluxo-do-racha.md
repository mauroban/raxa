...
- **O 🧤 é um slot como os outros (D-117).** Não tem folha de goleiro: o slot do gol entra na mesma gramática de toque/arraste, e uma **vaga** de linha (tracejada, "＋ vaga") também. Os pares que resolvem:
  ...
  A dica abaixo da escalação diz o que a marca pede ("Fulano sai do gol — toque em quem vai para o gol", "Gol vazio — toque em quem vai para o gol", "Vaga na linha — toque em quem entra"). Quem entra no lugar do goleiro **é o goleiro**, venha do rodízio ou não. `↶` desfaz qualquer um desses lances inteiro. Na tela de próxima partida o 🧤 continua abrindo a folha (rodízio / alguém do time / sem goleiro): ali não há partida rodando, e improvisar alguém do time abre a vaga de linha a completar, como qualquer time curto — e quem completa **entra de fato na largada** (D-122; antes era cortado e o time largava 4v5).
