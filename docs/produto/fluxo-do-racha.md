...
- **Entre uma partida e outra existe uma tela inteira: a próxima partida.** Não é um modal que some — é a tela padrão do racha enquanto nada está rolando (D-129), e ela mostra, nesta ordem:
  ...
  - **a fila, numerada, no mesmo cartão, logo abaixo dos lados** — as duas colunas da fila ficam exatamente embaixo das duas colunas dos lados, sem "VS" no meio nem título: o risco "entram no próximo" já diz o que é, e "depois" separa quem espera mais um. O número e a etiqueta ficam dentro do nome. Quem **saiu** na última roda leva a etiqueta **saiu**, em vermelho discreto, do mesmo jeito que quem entrou leva **entrou** no lado — quem lança vê tudo o que a roda fez. O goleiro que espera aparece com o 🧤, junto do time dele. A partida ao vivo mostra a mesma fila, com o mesmo corte, e marca "saiu" em quem foi substituído nesta partida;
