...
| RF-12.13 | Endereço da quadra nos Ajustes com busca por sugestões: link do Google Maps no cartão (D-179, D-180); no texto do grupo só quando a busca for do Google Maps (D-182) | P2 | ✅ v1 (cartão) · ⬜ (texto) |
