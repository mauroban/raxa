...
**Acima do esperado tem o primeiro lugar (D-203).** Como nem todo racha é montado equilibrado, a régua que não depende da montagem é **vitórias reais − esperadas pelo confronto, por partida**. Na ficha ela vem logo abaixo do aproveitamento: **"+12% acima do esperado"** (verde), **"−8% abaixo do esperado"** (vermelho) ou "0% dentro do esperado", com a explicação curta ao lado. Nos gerais do racha o ranking **Rendeu acima do esperado** abre a lista em todo período, antes de presenças e aproveitamento, e na faixa "Posição nos rankings" da ficha ele vem antes de "aproveit.". Tudo isso só com as patentes abertas, como o ranking já era (D-143); com elas fechadas nada muda.
