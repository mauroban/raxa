...
**Leão do fim do racha (D-208).** No fim do racha todo mundo está cansado, e quem rende ali rende de verdade. O **fim** é o **último terço das partidas de cada racha** (arredondado para cima: 12 partidas → as 4 últimas; racha com menos de 3 partidas não tem fim). Nos gerais do racha, em Mês, Ano e Sempre, dois rankings logo depois do ritmo: **Leão do fim do racha** — % de vitória real − esperada por partida, contando só as partidas do fim (com as patentes fechadas, o aproveitamento ali); a linha de baixo diz o V/E/D no fim e os gols ali; piso: metade dos rachas do período **e 3 partidas no fim** — e **Gols por hora no fim do racha** — gols de linha por hora de linha no fim, com 20 min de linha lá (um terço da 1 h dos outros ritmos). No período **Último** (um racha) o card Destaques do racha ganha o **Leão do fim do racha** daquele racha: o saldo acima do esperado nas últimas partidas dele (a dica diz quantas são), com 2 partidas no fim; empate desempata por gols no fim. Na ficha, a faixa Posição nos rankings ganha "fim do racha" (só na leitura de linha). Nada disso mexe no nível: é leitura, não motor (o cansaço no rating fica para quando houver ~100 partidas — [Ideias futuras §5](ideias-futuras.md)).
