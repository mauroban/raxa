...
**Craque e artilheiro do período, em pódio (D-210, D-211).** A primeira coisa da aba **Racha** no Último (um racha), no Mês e no Ano é um card com dois pódios, um embaixo do outro: **Craque do racha / do mês / do ano** e **Artilheiro do racha / do mês / do ano**. Cada pódio tem **2º | 1º | 3º**, com degraus de ouro, prata e bronze. O **1º tem bem mais destaque**: o degrau do meio é quase o dobro da largura dos outros e o dobro da altura, o nome vai em 30 px (22 px no empate) com a **coroa** em cima, e o número em 24 px; 2º e 3º são o primeiro nome (com a inicial do sobrenome se houver outro igual) em 13 px. O pódio do artilheiro é o mesmo em tamanho menor, sem coroa. O craque é **quem jogou melhor, não quem tem a maior patente**: o maior **acima do esperado por partida** (% de vitória real − esperada; "acima do esperado" escrito à direita do título), com o mesmo piso da lista racha a racha (3 partidas num racha; metade dos rachas num mês ou ano) — com as patentes fechadas, o maior aproveitamento. O artilheiro é quem fez mais gols (de linha + do gol). **Empate divide o degrau** (1, 1, 3 — D-89): os empatados sobem juntos, o de maior patente primeiro, até 3 nomes no 1º e 2 nos outros, e "e mais N"; o degrau que ficou sem ninguém aparece apagado. Tocar num nome abre a ficha. Ninguém no piso: uma linha dizendo o piso. Em **Sempre** não há card (é carreira, não um período que se fecha). É a mesma conta (`destaquesPer`) do chip de cada linha do racha a racha / mês a mês: o craque que aparece no chip do racha de 12/09 é o que abre no topo quando se toca nele. O ranking **Rendeu acima do esperado** leva a mesma coroa; no racha (Último) ele passou a ser **por partida** como no mês e no ano (era o saldo somado), para o primeiro dele ser o craque.
