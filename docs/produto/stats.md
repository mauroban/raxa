...
**Craque e artilheiro do período (D-210).** A primeira coisa da aba **Racha** no Último (um racha), no Mês e no Ano é um card com dois quadros lado a lado: **Craque do racha / do mês / do ano** (coroa, fundo dourado) e **Artilheiro**. O craque é **quem jogou melhor, não quem tem a maior patente**: o maior **acima do esperado por partida** (% de vitória real − esperada), com o mesmo piso da lista racha a racha (3 partidas num racha; metade dos rachas num mês ou ano) — com as patentes fechadas, o maior aproveitamento. Embaixo do nome, o número ("+14% acima do esperado") e, se é um só, "9 partidas · 5V 2E 2D". O artilheiro é quem fez mais gols (de linha + do gol), com o número embaixo. **Empate traz todo mundo** ("Craques do mês", os nomes um embaixo do outro, o de maior patente primeiro; de 4 para cima, dois nomes e "e mais N"). Tocar num nome abre a ficha. Ninguém no piso: "—" e o piso escrito. Em **Sempre** não há card (é carreira, não um período que se fecha). É a mesma conta (`destaquesPer`) do chip de cada linha do racha a racha / mês a mês: o craque que aparece no chip do racha de 12/09 é o que abre no topo quando se toca nele. O ranking **Rendeu acima do esperado** leva a mesma coroa; no racha (Último) ele passou a ser **por partida** como no mês e no ano (era o saldo somado), para o primeiro dele ser o craque.
