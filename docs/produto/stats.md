...
- **Níveis** (só com as patentes abertas) — a **escada de hoje** entre quem apareceu no período, como uma faixa proporcional com uma cor por patente (toque abre a aba Jogadores); tiles de quantos **subiram**, **caíram** e ficaram **no mesmo nível**; e os rankings **Quem mais subiu** e **Quem mais caiu**, em divisões, com o badge de onde saiu → onde chegou.
