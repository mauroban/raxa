...
**Leão do fim do racha (D-208).** No fim do racha todo mundo está cansado, e o leão é **quem cresce ali**: quem só faz gol no final. Uma partida é **do fim** quando **quem começa em quadra nela já tem, em média, mais de 50 min de jogo naquele racha nas pernas** (tempo de trecho que contou, pausas fora — a média de quem está no primeiro trecho da partida). É cansaço medido, não posição na lista: racha de 2 h tem mais fim que racha de 1 h, e um racha curto pode não ter fim nenhum. O número é **gols por hora de linha no fim − gols por hora de linha no resto do racha**: quem fez 1 no fim e 5 no resto não é leão; quem fez 3 no fim e nada antes é. Nos gerais do racha, em Mês, Ano e Sempre, o ranking **Leão do fim do racha** vem logo depois de Gols por hora, mostra a diferença ("+1,8", verde) e, na linha de baixo, as duas taxas ("2,4/h no fim · 0,6/h no resto"). **Sem o piso de rachas** dos outros rankings — nem todo racha tem fim; o piso é 20 min de linha no fim, 20 min de linha no resto e gol no fim. No período **Último** (um racha) o card Destaques do racha ganha o Leão daquele racha, com a mesma conta dentro dele (a dica diz quantas partidas foram o fim; linha de baixo "2 gols em 25 min no fim · 1 gol em 50 min no resto"; basta tempo de linha nos dois lados e gol no fim). Na ficha, a faixa Posição nos rankings ganha "fim do racha" (só na leitura de linha). Nada disso mexe no nível: é leitura, não motor (o cansaço no rating fica para quando houver ~100 partidas — [Ideias futuras §5](ideias-futuras.md)).
