...
**Sequências (D-202).** "Vitórias seguidas" é sem nada no meio: **empate ou derrota zera** a sequência de vitórias (antes o empate era transparente, e 4V podia ter um empate dentro). A ficha mostra a sequência de agora — **"N vitórias seguidas agora"** em verde ou **"N derrotas seguidas agora"** em vermelho, a partir de 2 — e as maiores do período, a partir de 3: **"melhor sequência: N vitórias"** e **"pior sequência: N derrotas"**. O ranking **Maior sequência** segue só com vitórias; derrotas seguidas ficam na ficha da pessoa, não viram ranking.
