...
- **Cada ranking da noite** (melhor +/−, quem mais ganhou, rendeu acima, tempo em quadra, menos vazado e, por último, os de gol — artilheiro, gol de goleiro, leão —, D-221) mostra 3 e abre **até 10** com o "▾ ver até N" — o mesmo padrão da temporada. Não há ranking de derrotas em lugar nenhum (D-134).
...
3. **Goleiro menos vazado** e **quem mais apareceu**. O artilheiro não entra nos destaques (D-221): o número de gols fica nos rankings, por último.
