...
- **Quem nunca jogou numa das duas simplesmente não tem patente ali.** O cara é Craque na linha e nunca
...
- O palpite do cadastro vale **só para a valência em que a pessoa vai jogar**. Cadastrar um Craque de linha
  não faz dele um Craque no gol.
